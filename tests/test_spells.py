...
def test_spells_decoder():
    ...
    assert fireballSpell.AtHigherLevels == "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd."
